...
#    ssl._create_default_https_context = ssl._create_unverified_context
    user_id = 'myUserId'
    token = 'Authorization get from https://opendata.cwb.gov.tw/index'
    url = 'https://opendata.cwb.gov.tw/fileapi/v1/opendataapi/F-C0032-001?Authorization='+token+'&format=JSON'
    ...
    url2 =  'https://opendata.cwb.gov.tw/fileapi/v1/opendataapi/F-C0032-010?Authorization='+token+'&format=JSON'
    ...
    line_bot_api.push_message(user_id , FlexSendMessage(alt_text='WeatherForcast', contents=flex))
